...
# This script preps a genome assembly for SISRS by:
# 1) Appending 'SISRS_' to each contig
# 2) Creating a file with the lengths of each contig
# 3) Creating a file with each individual locus listed
# Arguments: Path to SISRS folder with genome named 'contigs.fa' (e.g. /home/Mammals/SISRS/premadegenome)
# Output: (1) Backup contig file (2) Renamed contig file (3) Sequence Length TSV (4) LocList
